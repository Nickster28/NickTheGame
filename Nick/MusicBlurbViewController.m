...
#import "MusicBlurbViewController.h"
#import "AudioHandler.h"


@implementation MusicBlurbViewController
...
- (IBAction)continueToNextGame:(id)sender
{
    if ([self presentingViewController]) {
        ...
        [self performSegueWithIdentifier:@"goToGame2" sender:sender];
    }
}
